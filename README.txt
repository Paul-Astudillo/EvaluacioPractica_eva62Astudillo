...
a persistence unit "eva62AstudilloPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Astudillo/pom.xml":
...
artifact ("eva62Astudillo.war") is already built. You can build
